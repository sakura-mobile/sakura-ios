...
Rectangle {
    ...
    Image {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            source: rectangleLevel.sourceImgLattern //"qrc:/resources/images/lattern.png"
        ...
        onClicked: {
            if (isAvaible) {
                ...
                if (component.status === Component.Ready) {
                    mainStackView.push(component,{currentLevel:currentLevel, currentLocation:currentLocation, currentCampaign:currentCampaign });
                } else {
