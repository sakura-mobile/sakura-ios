...
Item {
     ...
     Component.onCompleted: {
         ...
         for(var keyLevel in listLevels) {
             ...
             if (maxLevelCampaign < currentCampaign || (maxLevelCampaign === currentCampaign &&  maxLevelLocation < currentLocation) ||  (maxLevelCampaign === currentCampaign &&  maxLevelLocation === currentLocation && keyLevel > maxLevel)) {
                ...
                object.isAvaible = true;
                 if (arrRatingLevels[currentCampaign] !== undefined && arrRatingLevels[currentCampaign][currentLocation] !== undefined && arrRatingLevels[currentCampaign][currentLocation][keyLevel] !== undefined) {
